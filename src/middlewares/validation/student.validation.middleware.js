...
export async function updateStudentByTeacherValidation(req, res, next) {
  try {
    const { error: schemaError } = updateStudentByTeacherSchema.validate(
      req.body
    );
    if (schemaError) {
      return res
...
export async function updateStudentByAdminValidation(req, res, next) {
  try {
    const { error: schemaError } = updateStudentByAdminSchema.validate(
      req.body
    );
    if (schemaError) {
      return res
...
export async function updateStudentByParentValidation(req, res, next) {
  try {
    const { error: schemaError } = updateStudentByParentSchema.validate(
      req.body
    );
    if (schemaError) {
      return res
...
export async function updateStudentParentByAdminValidation(req, res, next) {
  try {
    const { error: schemaError } = updateStudentParentByAdminSchema.validate(
      req.body
    );
    if (schemaError) {
      return res
