...
export async function feeHeadCreateValidation(req, res, next) {
  try {
    const { error: schemaError, value } = createFeeHeadSchema.validate(req.body);
...
export async function feeHeadUpdateValidation(req, res, next) {
  try {
    const { error: schemaError, value } = updateFeeHeadSchema.validate(req.body);
...
export async function feeStructureCreateValidation(req, res, next) {
  try {
    const { error: schemaError, value } = createFeeStructureSchema.validate(req.body);
...
export async function feeStructureUpdateValidation(req, res, next) {
  try {
    const { error: schemaError, value } = updateFeeStructureSchema.validate(req.body);
