...
import {
  ...
  getAllSubjectsOfTeacherInSectionController,
  getAllSubjectsTeachersOfSectionController,
  getAllSubjectsTeachersOfSectionForAdminController,
  updateTeacherSubjectSectionController
...
teacherSubjectSectionRouter.get(
  "/admin/:teacherSubjectSectionId",
  adminAuthenticate,
  getAllSubjectsTeachersOfSectionForAdminController
);
teacherSubjectSectionRouter.put(
  "/admin/:teacherSubjectSectionId",
  adminAuthenticate,
  updateTeacherSubjectSectionController
);
teacherSubjectSectionRouter.delete(
  "/admin/:teacherSubjectSectionId",
  adminAuthenticate,
  deleteTeacherSubjectSectionController
);
