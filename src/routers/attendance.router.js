...
import {
  ...
  undoAttendanceByTeacherController
...
attendanceRouter.post(
  "/teacher",
  teacherAuthenticate,
  authorizeTeacherRoles("classTeacher", "guestTeacher"),
  attendanceByTeacherValidation,
  attendanceByTeacherController
);
...
attendanceRouter.post(
  "/teacher/bulk-mark/:sectionId",
  teacherAuthenticate,
  bulkAttendanceMarkController
);
attendanceRouter.post(
  "/admin/bulk-mark/:sectionId",
  adminAuthenticate,
  bulkAttendanceMarkController
);
