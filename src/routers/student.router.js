...
studentRouter.post("/teacher", teacherAuthenticate, authorizeTeacherRoles('teacher'), registerStudentValidation, registerStudentController );
...
studentRouter.delete("/teacher/:studentId", teacherAuthenticate, authorizeTeacherRoles('teacher'), deleteStudentValidation, deleteStudentController );
...
studentRouter.put("/teacher/:studentId", teacherAuthenticate, authorizeTeacherRoles('teacher'), updateStudentByTeacherValidation, updateStudentController );
